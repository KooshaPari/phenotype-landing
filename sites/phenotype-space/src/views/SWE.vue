...
<template>
  <section>
    <h1>SWE</h1>
    <p class="lede">Software projects from the phenotype org. Most are Rust or TypeScript.</p>
...
.card { padding: 1.5rem; border: 1px solid #1c1f25; border-radius: 12px; background: #11141a; }
